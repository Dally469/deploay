...
import 'package:ralga/pages/decentralization/decentralization.dart';
              ...
              child: Row(
                ...
                children: [
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          SizedBox(width: 4,),
                          isNew == false ? Icon(Icons.check_circle, size: 25, color: appColor,) : Icon(Icons.check_circle, color: whiteColor,),
                          Column(
                  ...
                  InkWell(
                    onTap: () {
                      setState(() {
                        Navigator.push( context,MaterialPageRoute( builder: (context) => Decentralization()),);
                      });
                    },
                    child: Container(
                      height: 50,
                      ...
                      child: Row(
                        ...
                        children: [
                          SizedBox(width: 4,),
                          isNew == false ? Icon(Icons.check_circle, size: 25, color: whiteColor,) : Icon(Icons.check_circle, color: whiteColor,),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          SizedBox(width: 4,),
                            isNew == true ? Icon(Icons.check_circle, size: 25, color: appColor,) : Icon(Icons.check_circle, color: whiteColor,),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
