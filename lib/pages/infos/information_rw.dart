...
import 'package:ralga/pages/decentralization/decentralization-rw.dart';
import 'package:ralga/pages/infos/laws-category-en.dart';
import 'package:ralga/pages/infos/laws-category-rw.dart';
import 'package:ralga/pages/user_manual/user_manual_rw.dart';
import 'package:ralga/utils/colors.dart';
import 'package:ralga/widgets/app-icon.dart';

class InformationRW extends StatefulWidget {
  const InformationRW({Key? key}) : super(key: key);

  @override
  State<InformationRW> createState() => _InformationRWState();
}

class _InformationRWState extends State<InformationRW> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => DecentralizationRW()),
                          );
                        },
                        child: Align(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      "Politike Ubuyobozi Bwegereye Abaturage",
                                                      style: TextStyle(
                                                          color: appDarkColor,
                                                          fontSize: 18,
                                                          fontWeight:
