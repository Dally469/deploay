...
import '../user_manual/user_manual_en.dart';
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: (){
                        Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const UserManualEN()
                              ),
                            );
                      },
                      child: Align(
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          mainAxisAlignment: MainAxisAlignment.center,
                                                children: [
                                                  Text("USER MANUAL", style: TextStyle(color: appDarkColor, fontSize: 15, fontWeight: FontWeight.bold),),
                                                  SizedBox(height: 4,),
